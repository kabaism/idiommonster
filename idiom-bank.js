const RAW_IDIOM_BANK = {
  ...
  advanced: [
    ...
    { idiom: "審時度勢", meaning: "觀察時機與局勢，再作出適當判斷", hint: "先看情勢，再決定怎麼做", wrongMeanings: ["不管外在變化，照原計畫一路做到底", "只憑一時情緒，立刻做出決定", "遇到選擇時一直拖延，不肯下判斷"], funnyMeaning: "先把風向、氣氛和同學表情都掃描一遍，才肯按下開始鍵" },
